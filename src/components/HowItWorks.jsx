  ...
  const steps = [
    {
      ...
      description: "Select a monthly amount and tenure that fits your budget and financial goals."
    },
    {
      icon: (
        <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Pay periodic installments monthly and join our trusted community of investors."
    },
    {
      icon: (
        <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Bidding / Draw Process",
      description: "Each month, one or more members win the pooled amount via auction or draw."
    },
    {
      icon: (
        <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Payout / Residual Balance",
      description: "The winner takes the amount (minus commission), and the remaining pool is shared among non-winners."
    },
    {
      icon: (
        <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Continue Until Maturity",
      description: "Over the full tenure, every member gets their turn or share of the pool."
    }
  ];
